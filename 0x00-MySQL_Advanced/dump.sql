...
<meta name="csrf-token" content="CxoQw9osHxMDYlJJXorAYr2noyCDfYYjA1gBcOoRj3hu5GnETres1XXF4ffEsQ4qW37VVu3QukkNlUpTX1ImbQ" />
      ...
      <!-- React -->
      <script src="/packs/js/application-95c65a12a7f78f47ed19.js"></script>
  ...
  <form class="sm-gap" id="new_user" action="/auth/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="RTJUQT6l6d5ef-v5b6OjTbKe0KZVgOjcbiv_lf3sl6X8MRaHdJMsyCBxUwl3cSjgaES-LwYwZ2LegFhamAWkQQ" autocomplete="off" />
